...
def solution_part2():
    rooms = """gbc-frperg-pubpbyngr-znantrzrag-377[rgbnp]
    ...
    for r in rooms.split('\n'):
        letters, sec_id = parse_encrypted(r.strip())
        if letters:
            decrypted_sentence = rotate(letters, sec_id)
            if 'northpole' in decrypted_sentence:
